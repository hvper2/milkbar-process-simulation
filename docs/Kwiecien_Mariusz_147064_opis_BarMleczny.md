...
Projekt polega na symulacji funkcjonowania baru mlecznego, składającego się z sali jadalnej ze stolikami o różnej pojemności, stanowiska kasowego, pracownika obsługi wydającego posiłki oraz kierownika. Symulacja zostanie zrealizowana w środowisku Linux przy użyciu procesów oraz mechanizmów IPC: semaforów, pamięci dzielonej i kolejek komunikatów.

## Założenia funkcjonalne

- W barze znajdują się stoliki: **X1 (1-os.), X2 (2-os.), X3 (3-os.), X4 (4-os.)**.
- Maksymalna liczba klientów jedzących posiłek wynosi **N**.
...
- Po jedzeniu klienci muszą odnieść naczynia (indywidualnie lub jedna osoba z grupy).
- Kierownik może wysłać trzy sygnały sterujące:
  ...
  - **Sygnał 2 – rezerwacja:** wyłączenie z użytku określonej liczby stolików/miejsc (ustalanej z pracownikiem).
